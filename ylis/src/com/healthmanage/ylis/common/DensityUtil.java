...
public class DensityUtil {
	...
	// lp.width = (int) (((float) getScreenWidthPix(view.getContext()) -
	// DensityUtil.dip2px(view.getContext(), 25)) / scale);
	// lp.height = (int) (((float) getScreenWidthPix(view.getContext()) -
	// DensityUtil.dip2px(view.getContext(), 25)) / scale);
	// lp.setMargins(0, DensityUtil.dip2px(view.getContext(), 5),
	// DensityUtil.dip2px(view.getContext(), 5),
	// DensityUtil.dip2px(view.getContext(), 5));
