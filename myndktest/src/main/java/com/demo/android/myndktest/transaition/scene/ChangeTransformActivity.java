...
public class ChangeTransformActivity extends AppCompatActivity {
    ...
    private void initScene() {
        scene1 = Scene.getSceneForLayout(llGroup, R.layout.change_transform_scene_1, context);
        scene2 = Scene.getSceneForLayout(llGroup, R.layout.change_transform_scene_2, context);
    ...
    private void chenge(){
        ...
        TransitionManager.go(scene2, new ChangeTransform());
        isScene = !isScene;
